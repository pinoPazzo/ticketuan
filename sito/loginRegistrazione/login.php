...
<head>
  ...
  <link rel="stylesheet" href="loginRegistrazione.css">
            ...
            <div class="col-md-6 col-lg-7 d-flex align-items-center">
              <div class="card-body p-4 p-lg-5">
                ...
                <form>
                  ...
                  <div class="pt-1 mb-4">
                    <button data-mdb-button-init data-mdb-ripple-init class="btn btn-block btn-outline-warning" type="button">Login</button>
                  </div>

                  <a class="small text-muted" href="#!">Password dimeticata?</a>
                  <p class="mb-5 pb-lg-2" style="color: #393f81;">Non hai un account? 
                  <a href="registrazione.html"style="color: #393f81;">Registrati</a></p>
